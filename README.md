...
### Team Members
- Member 1: [Prardhana P Nair]  - [CEC]
- Member 2: [Keerthana Raj] - [CEC]
...
Libraries used: Leaflet.js (maps), Firebase JS SDK
...
- Feature 1: [Search Area Safety Check: Users can enter an area name to check its safety on a map.]
- Feature 2: [Live Location Safety Check: Users can use GPS to check their current location’s safety.]
- Feature 3: [Interactive Map: Displays location markers and dynamic map view using Leaflet.js.]
- Feature 4: [SOS Alert System: Users can send emergency alerts, which are stored in Firebase for monitoring.]
